        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate__animated animate__fadeIn">
            ...
            <p className="text-xl text-neutral-300 max-w-2xl mx-auto">
              Join our growing network of quality establishments providing clean facilities across India
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            <div className="bg-neutral-800 p-8 rounded-xl border border-neutral-700 shadow-xl animate__animated animate__fadeInLeft">
              ...
              <ul className="space-y-4">
                {[
                  { title: "Increased Foot Traffic", description: "Attract new customers through our platform" },
                  { title: "Brand Visibility", description: "Featured listing in our mobile app" },
                  { title: "Eco-Friendly Recognition", description: "Special badges for sustainable practices" },
                ].map((benefit, index) => (
                  <li key={index} className="flex items-start">
                    <svg className="w-6 h-6 text-emerald-500 mt-1 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fillRule="evenodd"
            ...
            <div className="bg-neutral-800 p-8 rounded-xl border border-neutral-700 shadow-xl animate__animated animate__fadeInRight">
              ...
              <ul className="space-y-4">
                {[
                  { title: "Clean Facilities", description: "Maintain high hygiene standards" },
                  { title: "Accessibility", description: "Ensure easy access for all users" },
                  { title: "Regular Maintenance", description: "Commit to facility upkeep" },
                  ...
                  <li key={index} className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-white font-semibold mb-1">{requirement.title}</h4>
                      <p className="text-neutral-400">{requirement.description}</p>
                    </div>
                  </li>
                ))}
              </ul>
